...
background-image: url(img/voto.png?As1S);
...
<div class="menu1 col-md-7 col-md-offset-3">
      <ul class="nav navbar-nav">
        <li class="active">
        <li><a href="alumnos.php">Agregar afiliado</a></li>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <h1 class="text-center"><font color="white" size="7" face="Algerian">Registro de afiliado</font></h1>
    </div>
  </div>
...
<fieldset>
							<legend><em><strong><font color="white" >Selecione el districto</font></strong></em></legend>
						<?php
						...
						?>
							...
							<option value="" >Selecione el districto</option>
							<?php
								for ($i=0;$i<$num_reg;$i++){
					...
					<br>
  <div class="form-group">
    <label for="Usuario"><font color="white" size="4">Numero de DNI</font></label>
