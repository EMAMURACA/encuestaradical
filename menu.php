...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <h1 class="text-center"><font color="white" size="7" face="Algerian">SISTEMA DE VOTACION </font></h1>
    </div>
  </div>
...
<center>
     <a href="alumnos.php"><button class="btn btn-primary">  <font size="4">Agregar Afiliado</font></button></a>
